...
def get_latest_app_update_label() -> str:
...
def render_data_updated_line() -> None:
    st.markdown(
        f"<p style='margin-top:-0.2rem; margin-bottom:0.6rem; color:#60748a; font-size:0.92rem; font-style:italic;'>Data updated till {get_latest_app_update_label()}</p>",
        unsafe_allow_html=True,
    )
